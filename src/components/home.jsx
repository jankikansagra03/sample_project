    ...
    <>
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-amber-800 sm:text-3xl lg:text-5xl lg:leading-tight">
              Next-Gen Electronics{" "}
            </h1>
            <h1 className="block text-2xl font-bold text-amber-800 sm:text-2xl lg:text-4xl lg:leading-tight">
              Your One stop solution for Electronics Shopping
            </h1>
            <p className="mt-3 text-md text-amber-800">
              Discover the latest in technology - From smartphones to smart
              homes, find everything you need at unbeatable prices.
            </p>

            <div className="grid w-full gap-3 mt-7 sm:inline-flex">
              <a
                className="inline-flex items-center justify-center px-4 py-3 text-sm font-medium bg-white border border-gray-200 rounded-lg shadow-sm text-amber-800 gap-x-2 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                href="shop   .php"
              >
                Shop Now
              </a>
            ...
            <div className="grid grid-cols-2 mt-6 lg:mt-10 gap-x-5">
              <div className="py-5">
                <div className="flex gap-x-1">
                  <svg
                    className="text-amber-800 size-4"
                    width="51"
                    height="51"
                    viewBox="0 0 51 51"
                    fill="none"
                ...
                <div className="mt-5">
                  <svg
                    className="w-16 h-auto text-amber-800"
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
          ...
          <div className="relative ms-4">
            <img
              ...
              src="..//Images//carousel//860.jpeg"
              alt="Hero Image"
            />
            <div className="absolute inset-0 -z-[1] rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6"></div>
          </div>
        </div>
      </div>
      <br />
